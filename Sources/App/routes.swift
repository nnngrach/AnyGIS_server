...
//    router.get("", String.parameter, Int.parameter, Int.parameter,Int.parameter, use: controller.splitter)
//
//    router.get("", String.parameter, Double.parameter, Double.parameter,Int.parameter, use: controller.convertAndStartSplitter)
    
    router.get("", String.parameter, String.parameter, String.parameter,Int.parameter, use: controller.convertAndStartSplitter)
    ...
    router.get("list", use: controller.list)
